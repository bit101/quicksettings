declare module "quicksettings" {
  ...
  interface QuickSettingsPanel {
    ...
    collapse(): void;
    expand(): void;
    addBoolean(title: string, value: boolean): void;
    getValueAsJSON(asString: true): string;
    getValueAsJSON(asString: false): object;
    getValueAsJSON(): object;
    setValuesFromJSON(json: object | string): this;
    ...
    setGlobalChangeHandler(handler: AnyFunction): this;
    hide(): this;
    show(): this;
  ...
  export default interface QuickSettings {
    create(
      x: number,
      y: number,
      panelTitle?: string,
